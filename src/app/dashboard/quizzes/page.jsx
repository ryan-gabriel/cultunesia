...
const EmptyState = () => (
  ...
  >
    ...
    <p className="text-md mt-2">
      Mulai buat kuis pertama Anda untuk menguji wawasan pengguna.
    </p>
...
const Page = () => {
  ...
  const handleDelete = async (quiz) => {
    ...
    try {
      const res = await fetch(`/api/admin/quizzes/${quiz.quiz_id}`, {
        method: "DELETE",
      });
        ...
        >
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Buat dan kelola kuis interaktif untuk provinsi dan tantangan
              harian.
            </p>
          </div>
