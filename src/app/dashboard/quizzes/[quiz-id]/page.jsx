...
import { columns } from "@/components/dataTable/questions/columns"; // ubah path columns quizzes
import { DataTable } from "@/components/dataTable/questions/data-table"; // path DataTable quizzes
...
const Page = () => {
  ...
  const handleDelete = async (question) => {
    ...
    try {
      const res = await fetch(`/api/admin/quizzes/${question.quiz_id}/questions/${question.question_id}`, {
        method: "DELETE",
      });
