        ...
        <div className="container mx-auto px-6 py-24 sm:py-32 relative z-10">
          ...
          >
            ...
            >
              ...
              , berfokus untuk menghadirkan pengalaman interaktif yang elegan
              dan informatif.
            </motion.p>
          </motion.div>
          ...
          >
            {teamMembers.map((member) => (
              ...
              >
                <Card className="h-full text-center overflow-hidden bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-lg hover:shadow-2xl hover:shadow-amber-500/10 rounded-2xl transition-all duration-300 border border-gray-200/50 dark:border-gray-700/50 hover:border-amber-400/50 dark:hover:border-amber-600/50">
